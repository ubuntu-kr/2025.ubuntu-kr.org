...
To learn more about our sponsorship program, please refer to our sponsorship prospectus. However, registeration for UbuCon Korea 2025 Sponsorship program is currently closed. Prospectus for the next year may be opened after the event, so stay tuned!
...
| **Logo exposures** || |
| Basic | O | O | O | O | O | O |
| Recodings & Stage(or Podium) | O | O | X | X | X | X |
